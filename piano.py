...
def dibujar_teclas():
    global do4, dosus4, re4, resus4, mi4, fa4, fasus4, sol4, solsus4, la4, lasus4, si4, boton
...
def update():
    ...
    if switch == False:
        ...
        if keyboard.w:
            music.play_once("pato")
        if keyboard.k_3:
            music.play_once("cerdo")
        #grupo 2
        if keyboard.e:
            music.play_once("caballo")
        if keyboard.r:
            music.play_once("cabra")
        if keyboard.k_5:
            music.play_once("cuervo")
        if keyboard.t:
            music.play_once("elefante")
        #grupo 3
        if keyboard.k_6:
        ...
        if keyboard.k_7:
            music.play_once("mono")
        if keyboard.u:
            music.play_once("tigre")
        if keyboard.k_8:
            music.play_once("vaca")
